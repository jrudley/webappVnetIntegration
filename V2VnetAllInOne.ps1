...
if ($subs.Length -eq 1) {
    ...
    foreach ($subscription in $subs) {
        ...
        $subscriptionChoices += "$($subscription.Name) ($($subscription.SubscriptionId))";
...
$resourceGroup = Read-Host "Please enter the Resource Group of your WebApp"

$appName = Read-Host "Please enter the Name of your WebApp"

$options = @("Add a NEW Virtual Network to an App", "Add an EXISTING Virtual Network to a WebApp", "Remove a Virtual Network from a WebApp");
$optionValues = @(0, 1, 2)
